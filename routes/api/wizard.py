...
_DEPENDENCIES = {
    ...
    "subclass": ["subclass_features", "spells", "cantrips", "aspect_of_the_wilds", "primal_lore_skill", "knowledge_artisan_tool", "knowledge_skills", "land_type"],
    "primal_order": ["magician_bonus_cantrip"],
    "background": [
        "background_bonuses",
        "background_skill_replacement",
        "origin_feat",
