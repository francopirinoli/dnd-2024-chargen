...
![](img/book/EFA/000-09-003.title-image-construct.webp)
...
![The Artificers of Eberron are responsible for many amazing inventions, but none more miraculous than the Warforged](img/book/EFA/001-01-001.artificer-working-on-an-unfinished-warforged.webp)
...
<table class="ve-rd__b-special ve-rd__b-data  ve-rd__b-data--stats">
		<thead>
				...
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Artificer</span>
			...
			<td colspan="6" data-rd-tag="class" data-rd-uid="Artificer|EFA" data-rd-page="classes.html" data-rd-source="EFA" data-rd-hash="artificer_efa" data-rd-name="Artificer" data-rd-display-name="Artificer" data-rd-style="" data-rd-entry-data="{}">
				<i>Loading <a href="classes.html#artificer_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="classes.html" data-vet-source="EFA" data-vet-hash="artificer_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Artificer</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
## Artificer Subclasses

An Artificer subclass is a specialization that grants you features at certain Artificer levels, as specified in the subclass. This section presents the Alchemist, Armorer, Artillerist, and Battle Smith, and Cartographer.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ">Alchemist</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 ve-hidden"></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[+]</span>
					</div>
				</th>
			</tr>
		</thead><tbody class="ve-hidden" data-rd-embedded-data-render-target="true"><tr>
			<td colspan="6" data-rd-tag="subclass" data-rd-uid="Alchemist|Artificer|EFA|EFA" data-rd-page="subclass" data-rd-source="EFA" data-rd-hash="artificer_efa,state:sub_alchemist_efa=b1" data-rd-name="Alchemist" data-rd-display-name="Alchemist" data-rd-style="" data-rd-entry-data="{}">
				<i>Loading <a href="classes.html#artificer_efa,state:sub_alchemist_efa=b1"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="classes.html" data-vet-source="EFA" data-vet-hash="artificer_efa,state:sub_alchemist_efa=b1" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Alchemist</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ">Armorer</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 ve-hidden"></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[+]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="subclass" data-rd-uid="Armorer|Artificer|EFA|EFA" data-rd-page="subclass" data-rd-source="EFA" data-rd-hash="artificer_efa,state:sub_armorer_efa=b1" data-rd-name="Armorer" data-rd-display-name="Armorer" data-rd-style="" data-rd-entry-data="{}">
				<i>Loading <a href="classes.html#artificer_efa,state:sub_armorer_efa=b1"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="classes.html" data-vet-source="EFA" data-vet-hash="artificer_efa,state:sub_armorer_efa=b1" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Armorer</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table><table class="ve-rd__b-special ve-rd__b-data  ve-rd__b-data--stats">
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ">Artillerist</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 ve-hidden"></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[+]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="subclass" data-rd-uid="Artillerist|Artificer|EFA|EFA" data-rd-page="subclass" data-rd-source="EFA" data-rd-hash="artificer_efa,state:sub_artillerist_efa=b1" data-rd-name="Artillerist" data-rd-display-name="Artillerist" data-rd-style="" data-rd-entry-data="{}">
				<i>Loading <a href="classes.html#artificer_efa,state:sub_artillerist_efa=b1"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="classes.html" data-vet-source="EFA" data-vet-hash="artificer_efa,state:sub_artillerist_efa=b1" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Artillerist</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table><table class="ve-rd__b-special ve-rd__b-data  ve-rd__b-data--stats">
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ">Battle Smith</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 ve-hidden"></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[+]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="subclass" data-rd-uid="Battle Smith|Artificer|EFA|EFA" data-rd-page="subclass" data-rd-source="EFA" data-rd-hash="artificer_efa,state:sub_battle%20smith_efa=b1" data-rd-name="Battle Smith" data-rd-display-name="Battle Smith" data-rd-style="" data-rd-entry-data="{}">
				<i>Loading <a href="classes.html#artificer_efa,state:sub_battle%20smith_efa=b1"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="classes.html" data-vet-source="EFA" data-vet-hash="artificer_efa,state:sub_battle%20smith_efa=b1" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Battle Smith</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table><table class="ve-rd__b-special ve-rd__b-data  ve-rd__b-data--stats">
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ">Cartographer</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 ve-hidden"></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[+]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="subclass" data-rd-uid="Cartographer|Artificer|EFA|EFA" data-rd-page="subclass" data-rd-source="EFA" data-rd-hash="artificer_efa,state:sub_cartographer_efa=b1" data-rd-name="Cartographer" data-rd-display-name="Cartographer" data-rd-style="" data-rd-entry-data="{}">
				<i>Loading <a href="classes.html#artificer_efa,state:sub_cartographer_efa=b1"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="classes.html" data-vet-source="EFA" data-vet-hash="artificer_efa,state:sub_cartographer_efa=b1" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Cartographer</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
## Spell
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Homunculus Servant</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="spell" data-rd-uid="Homunculus Servant|EFA" data-rd-page="spells.html" data-rd-source="EFA" data-rd-hash="homunculus%20servant_efa" data-rd-name="Homunculus Servant" data-rd-display-name="Homunculus Servant" data-rd-style="" data-rd-entry-data="{}">
				<i>Loading <a href="spells.html#homunculus%20servant_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="spells.html" data-vet-source="EFA" data-vet-hash="homunculus%20servant_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Homunculus Servant</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
...
![An Artificer and his creation meet each other for the first time](img/book/EFA/007-02-001.artificer-and-creation-first-meeting.webp)
...
![Left to Right: Mark of Detection, Mark of Shadow, Mark of Making](img/book/EFA/008-02-005.dragonmarks.webp)
...
![Left to Right: Greater Mark of Detection, Greater Mark of Shadow, Greater Mark of Making](img/book/EFA/009-02-006.greater-dragonmarks.webp)
...
![Left to Right: Siberys Mark of Detection, Siberys Mark of Shadow, Siberys Mark of Making](img/book/EFA/010-02-007.siberys-dragonmarks.webp)
...
![Adventurers bring a mysterious artifact recovered from Xen'drik back to their mobile Bastion aboard a Lyrandar sailing ship](img/book/EFA/036-03-001.mobile-bastion-aboard-lyrandar-sailing-ship.webp)
...
|   13  | Inquisitive Agency | None                                                   | Research |
...
![A Battle Smith inquisitive trails his quarry through the streets and towers of Sharn](img/book/EFA/038-04-001.battle-smith-inquisitive-on-the-hunt.webp)
...
![Inquisitives in Sharn keep constant watch over criminal activity in the city, no matter where it occurs](img/book/EFA/039-04-002.inquisitives-in-sharn-keeping-watch.webp)
...
![The criminals of Sharn come in different shapes, in different sizes, and from different planes of existence](img/book/EFA/040-04-003.criminals-of-sharn.webp)
...
***Boromar Smuggler.*** Smugglers employed by the Boromar Clan (mostly halflings) are notoriously hard to catch. These speedy criminals traffic everything from narcotics to illegal arcane weaponry across Sharn.

<table class="ve-rd__b-special ve-rd__b-data ve-rd__b-data--narrow ve-rd__b-data--stats">
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Boromar Smuggler</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Boromar Smuggler|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="boromar%20smuggler_efa" data-rd-name="Boromar Smuggler" data-rd-display-name="Boromar Smuggler" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#boromar%20smuggler_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="boromar%20smuggler_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Boromar Smuggler</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>***Boromar Underboss.*** Underbosses supervise larger clan operations, such as gambling halls and warehouses of smuggled goods awaiting transport. Accustomed to the criminal lifestyle, these hardy individuals (mostly halflings) dismiss and dispose of threats with calculated ease.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Boromar Underboss</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Boromar Underboss|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="boromar%20underboss_efa" data-rd-name="Boromar Underboss" data-rd-display-name="Boromar Underboss" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#boromar%20underboss_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="boromar%20underboss_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Boromar Underboss</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
### Daask
...
***Daask Bruiser.*** Intimidating and powerful, bruisers lead Daask operations when more violent and decisive shows of force are needed. These enforcers relish the brutality of their work.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Daask Bruiser</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Daask Bruiser|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="daask%20bruiser_efa" data-rd-name="Daask Bruiser" data-rd-display-name="Daask Bruiser" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#daask%20bruiser_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="daask%20bruiser_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Daask Bruiser</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>***Daask Raider.*** Raiders use guerrilla tactics to ambush warehouses and beat down opponents. These skilled fistfighters work in tandem to claim goods and territory for Daask.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Daask Raider</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Daask Raider|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="daask%20raider_efa" data-rd-name="Daask Raider" data-rd-display-name="Daask Raider" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#daask%20raider_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="daask%20raider_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Daask Raider</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
### The Dreaming Dark
...
***Dreaming Dark Infiltrator.*** **Dreaming Dark infiltrators** are spies sent to gather intelligence. They plant psychic seeds in their minds of their foes that enhance the infiltrators' combat prowess against those enemies.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Dreaming Dark Infiltrator</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Dreaming Dark Infiltrator|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="dreaming%20dark%20infiltrator_efa" data-rd-name="Dreaming Dark Infiltrator" data-rd-display-name="Dreaming Dark Infiltrator" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#dreaming%20dark%20infiltrator_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="dreaming%20dark%20infiltrator_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Dreaming Dark Infiltrator</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>***Dreaming Dark Mindkiller.*** Mindkillers are the assassins of the Dreaming Dark, sent to terrify their foes before striking to kill. Mindkillers force foes to attack their own allies, causing physical and emotional devastation to grow the power of the Dreaming Dark.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Dreaming Dark Mindkiller</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Dreaming Dark Mindkiller|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="dreaming%20dark%20mindkiller_efa" data-rd-name="Dreaming Dark Mindkiller" data-rd-display-name="Dreaming Dark Mindkiller" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#dreaming%20dark%20mindkiller_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="dreaming%20dark%20mindkiller_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Dreaming Dark Mindkiller</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
## Sharn Neighborhoods
...
![Something is always happening in the shadows of the City of Towers](img/book/EFA/041-04-004.city-of-towers.webp)
...
***Fire Inside.*** Daask acquired two **Hell Hounds** and got them inside the inn to start the fire and terrorize the folks inside. If the characters concentrate on fighting the monsters, the other people inside the inn can extinguish the flames.

***Panic Outside.*** Outside the burning inn, eight **Daask Raiders** (gnolls whose stat blocks appear in this chapter) are attacking terrified people fleeing from the fire as well as those trying to help put it out. Each gnoll tries to flee when Bloodied.

***No Great Mystery.*** Identifying the gnolls as agents of Daask isn't difficult—it's the conclusion most people jump to when they see gnolls involved in violence, and a number of clues back up that assumption:
...
- **Boromar Witness**. A halfling named Gressie Gorben (**Boromar Smuggler**; this stat block appears in this chapter)—was attacked by a gnoll that called her a "filthy Boromar." Gressie denies any ties to the Boromar Clan, but she admits to knowing that Daask and the Boromar Clan are involved in a long-running feud.
...
***Boromar Connection.*** In addition to Gressie Gorben's testimony, several clues point to a connection between the Gold Dragon Inn and the Boromar Clan:
...
***Watch Involvement.*** The Sharn Watch seems unusually eager to cooperate with the inquisitives, as long as the characters' attention is focused on Daask and not on any connection between the inn and the Boromar Clan. If they ask about Boromar ties, their Watch contacts urge them to focus on Daask.

***Daask Hideout.*** The characters' inquiries about Daask lead them to a hideout where some gang members await their next instructions. They include an **Ogre**, two **Harpies**, and four **Daask Raiders** (they include any survivors from the inn incident). Use the eastern half of the surface level portion of the Dungeon Hideout map in the *Dungeon Master's Guide* for this hideout.

***Reward.*** If the characters bring these Daask members to justice for their crimes, Irida d'Ghallanda pays them 500 GP (total) and politely requests that they end their investigation.
...
![Members of different dragonmarked houses set aside their differences to investigate a murder in Sharn, the City of Towers.](img/book/EFA/042-05-001.members-of-dragonmarked-houses.webp)
...
![](img/book/EFA/043-05-002.members-of-dragonmarked-houses-in-conflict.webp)
...
***Cannith.*** The leaders of House Cannith perished in the Mourning, and three powerful barons now vie for control. Each one wants to unite the house under their own leadership, but it's entirely possible the house could fracture as House Phiarlan did.

***Sivis.*** House Sivis is known for its neutrality in struggles between nations and dragonmarked houses alike—it often helps settle disputes and maintain order when two houses differ. But its own internal affairs involve a tremendous amount of family rivalry. The house's twelve families include the Corralyns, Lyrrimans, Santors, Severins, Syrralans, and Torralyns. Only because of her expertise at games of intrigue has Doyenne Lysse Lyrriman d'Sivis managed to head the house for ninety years.

***Tharashk.*** An ancient conflict lies hidden within the foundations of House Tharashk. The powerful Torrn clan has ties to the Gatekeeper druids, while the Aashta clan aligns with the Cults of the Dragon Below. Most modern heirs have only a casual knowledge of these traditions, but zealous factions within the clans pursue esoteric agendas that sometimes boil out into conflict within the house.
...
***Levels 1–4.*** As prominent but not yet powerful figures in the dragonmarked landscape, the characters become the targets of two rival houses. Both houses try to befriend and influence them, perhaps hiring them for various missions. Meanwhile, the conflict between the houses simmers on a back burner.

***Levels 5–10.*** The conflict between the two rival houses erupts into a trade war, a concerted effort to take over business from each other, or even violent conflict. With the characters now emerging as a force to be reckoned with, both houses call on them for help, trying to force the characters to choose sides.

***Levels 11–16.*** As the conflict between the two houses rages on, a third group gets involved, hoping to take advantage of the warring parties' distraction or weakness. Figures both within and outside the houses plead with the characters to help end the conflict before it engulfs other houses or even nations.

***Levels 17–20.*** The chaos spreads, and the characters have a choice to make. They can work to restore the delicate balance of power among the houses, as well as between the houses and the Five Nations. Or they can try to reshape the world order according to a different pattern.

![A Tarkanan Marauder and a Tarkanan Ruffian](img/book/EFA/044-05-003.tarkanan-marauder-and-ruffian.webp)
...
***Levels 1–4.*** A patron asks the characters to get involved in a criminal investigation into a rash of murders in Sharn because all the victims have dragonmarks. Both the Sharn Watch and one or more private inquisitives already squabble over access to evidence and witnesses—the characters' attempt to get involved merely heightens the tension. The perpetrators turn out to be members of House Tarkanan, whom the characters must bring to justice.

***Levels 5–10.*** After the characters' success in dealing with the Tarkanan killers, the Watch comes to them for additional help. Petty thieves belonging to the gang have offered inside information into House Tarkanan's plans in exchange for leniency in their sentencing. These thieves don't share their leaders' delusions of grandeur or hatred of the dragonmarked houses. The information points to a gathering of aberrant heirs deep below Sharn.

***Levels 11–16.*** After the characters disrupt House Tarkanan's schemes in the depths of Sharn, the gang sends powerful assassins with fearsome aberrant dragonmarks after the party.

***Levels 17–20.*** The Son of Khyber leads a small army of aberrant-marked warriors and assassins to challenge the leadership of Sharn—and plots to conjure a **Blob of Annihilation** to level the city's skyscraping towers.
...
***Tarkanan Marauder.*** This powerful assassin relies on teleportation to catch targets unaware and deal out rapid death.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Tarkanan Marauder</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Tarkanan Marauder|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="tarkanan%20marauder_efa" data-rd-name="Tarkanan Marauder" data-rd-display-name="Tarkanan Marauder" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#tarkanan%20marauder_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="tarkanan%20marauder_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Tarkanan Marauder</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>***Tarkanan Ruffian.*** This rank-and-file gang member, recruited off the streets of Sharn, uses sinister lightning powers to supplement ordinary weaponry.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Tarkanan Ruffian</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Tarkanan Ruffian|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="tarkanan%20ruffian_efa" data-rd-name="Tarkanan Ruffian" data-rd-display-name="Tarkanan Ruffian" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#tarkanan%20ruffian_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="tarkanan%20ruffian_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Tarkanan Ruffian</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
### The Chamber
...
***Levels 5–10.*** Dragonmarked characters come to the attention of a dragon belonging to the Chamber. The dragon sends an agent to meet them, become a friend or patron to them, and keep an eye on their activities. Occasionally the agent might send them on strange errands intended to fulfill the Prophecy in a particular way. Other times, the agent provides helpful advice, useful spells, or even magic items to aid the characters in adventures. Some missions, particularly later in this level range, might feel distasteful to the characters or directly conflict with their other goals.

***Levels 11–16.*** The dragon monitoring the characters becomes convinced that the characters' other activities are corrupting the Prophecy. The dragon's friendly agent disappears, and a group of hostile agents begins to undermine the characters' work.

***Levels 17–20.*** When the dragon alerts other members of the Chamber that the characters pose a threat to the Prophecy, multiple dragons attempt to eliminate the group.
...
![Agents of (Left to Right) House Deneith, House Ghallanda, House Lyrandar, House Cannith, House Jorasco, and House Kundarak](img/book/EFA/045-05-004.agents-of-the-houses.webp)

### House Cannith

![](img/book/EFA/046-05-006.house-cannith.webp)
...
***Favored in House (Renown 3+).*** You can purchase one Common or Uncommon magic item at half the usual cost.

***Recognized in House (Renown 10+).*** When you take a Bastion turn, you can issue the Craft order to House Cannith as if it were a Smithy or Workshop facility in your Bastion. If you are level 9+, you instead can treat the house as a Laboratory facility.

### House Deneith

![](img/book/EFA/047-05-013.house-deneith.webp)
...
***Favored in House (Renown 3+).*** You and your party can stay in a House Ghallanda inn for 30 days without charge, with meals included.

***Recognized in House (Renown 10+).*** When you take a Bastion turn, you can issue the Harvest order to House Ghallanda as if it were a Garden facility (food garden) in your Bastion. If you are level 13+, you instead can issue the Research order to House Ghallanda as if it were a Pub facility.

### House Jorasco

![](img/book/EFA/049-05-008.house-jorasco.webp)
...
***Favored in House (Renown 3+).*** You can purchase one *Potion of Healing* (any variety) at half the usual cost.

***Recognized in House (Renown 10+).*** When you take a Bastion turn, you can issue the Harvest order to House Jorasco as if it were a Garden facility (herb garden) in your Bastion. If you are level 9+, you instead can issue the Harvest order to the house as if it were a Greenhouse facility.

### House Kundarak

![](img/book/EFA/050-05-009.house-kundarak.webp)
...
***Favored in House (Renown 3+).*** You can store something in a Kundarak vault for up to 1 month at no charge. The vault is an extradimensional space accessible (with the proper keys) from any Kundarak bank in Khorvaire and is generally considered impenetrable.

***Recognized in House (Renown 10+).*** When you take a Bastion turn, you can issue the Trade order to House Kundarak as if it were a Storehouse facility in your Bastion, using your level to determine the maximum value of items purchased and the profit you get from selling them.

### House Lyrandar

![](img/book/EFA/051-05-010.house-lyrandar.webp)
...
***Favored in House (Renown 3+).*** You can secure passage on a House Lyrandar sailing ship for yourself and your party at no cost, or on an elemental galleon or airship for half the usual price.
...
![Agents of (Left to Right) House Medani, House Orien, House Tharashk, House Phiarlan, House Vadalis, and House Sivis](img/book/EFA/052-05-005.more-agents-of-the-houses.webp)

### House Medani

![](img/book/EFA/053-05-011.house-medani.webp)
...
***Favored in House (Renown 3+).*** You can secure overnight lodging in a Medani safe house for yourself and your party. Secreted away under the house's protection, you become almost impossible to find by nonmagical means.

***Recognized in House (Renown 10+).*** When you take a Bastion turn, you can issue the Research order to House Medani as if it were a Library facility in your Bastion. If you are level 13+, you instead can issue the Research order to the house as if it were a Pub facility.

### House Orien

![](img/book/EFA/054-05-012.house-orien.webp)
...
***Favored in House (Renown 3+).*** You can secure transportation for yourself and your party by any means House Orien provides (caravan, lightning rail, or teleportation) for half the usual cost.

***Recognized in House (Renown 10+).*** When you take a Bastion turn, you can issue the Trade order to House Orien as if it were a Storehouse facility in your Bastion, using your level to determine the maximum value of items purchased and the profit you get from selling them. If you are level 9+, you instead can issue the Recruit order to House Orien as if it were a Teleportation Circle facility within your Bastion.

### House Phiarlan

![](img/book/EFA/055-05-014.house-phiarlan.webp)
...
***Favored in House (Renown 3+).*** You can purchase one dose of poison (any kind) or other illegal item (such as stolen goods) at half price.

***Recognized in House (Renown 10+).*** When you take a Bastion turn, you can issue the Craft order to House Phiarlan as if it were a Workshop facility in your Bastion. If you are level 9+, you instead can issue the Empower order to the house as if it were a Theater facility, and if you are level 13+, you instead can issue the Research order to the house as if it were a Pub facility.

### House Sivis

![](img/book/EFA/056-05-016.house-sivis.webp)
...
***Favored in House (Renown 3+).*** You can obtain the translation or messaging services of House Sivis at no charge.

***Recognized in House (Renown 10+).*** When you take a Bastion turn, you can issue the Craft order to House Sivis as if it were an Arcane Study facility in your Bastion. If you are level 9+, you instead can issue the Craft order to your house as if it were a Scriptorium facility.

### House Tharashk

![](img/book/EFA/057-05-017.house-tharashk.webp)
...
***Favored in House (Renown 3+).*** You can purchase a dragonshard, or one Common or Uncommon magic item that incorporates dragonshards, at half the usual cost. Alternatively, you can request the assistance of a mercenary from Droaam (a **Harpy**, an **Ogrillon Ogre**, a **Spy**, or a **Thri-kreen Marauder**) for up to 1 day.

***Recognized in House (Renown 10+).*** When you take a Bastion turn and issue the Recruit order to a Barrack facility in your Bastion, you can recruit up to twelve Bastion Defenders instead of four. In addition, if you are level 9+, you can issue the Research order to House Tharashk as if it were a Trophy Room facility within your Bastion.

### House Thuranni

![](img/book/EFA/058-05-015.house-thuranni.webp)
...
***Favored in House (Renown 3+).*** You can purchase any animal for half the usual cost, or you can secure free feed and stabling for animals owned by you and your party for up to 1 week.

***Recognized in House (Renown 10+).*** When you take a Bastion turn, you can issue the Research order to House Vadalis as if it were a Library facility in your Bastion, as long as the topic of research is some kind of living creature. In addition, when you issue the Recruit order to a Menagerie facility in your Bastion, you pay half the usual cost for the creature you acquire.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Cannith Artificer</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Cannith Artificer|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="cannith%20artificer_efa" data-rd-name="Cannith Artificer" data-rd-display-name="Cannith Artificer" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#cannith%20artificer_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="cannith%20artificer_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Cannith Artificer</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Ghallanda Troubleshooter</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Ghallanda Troubleshooter|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="ghallanda%20troubleshooter_efa" data-rd-name="Ghallanda Troubleshooter" data-rd-display-name="Ghallanda Troubleshooter" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#ghallanda%20troubleshooter_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="ghallanda%20troubleshooter_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Ghallanda Troubleshooter</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
#### Jorasco Medic
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Jorasco Medic</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Jorasco Medic|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="jorasco%20medic_efa" data-rd-name="Jorasco Medic" data-rd-display-name="Jorasco Medic" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#jorasco%20medic_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="jorasco%20medic_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Jorasco Medic</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
#### Kundarak Warden
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Kundarak Warden</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Kundarak Warden|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="kundarak%20warden_efa" data-rd-name="Kundarak Warden" data-rd-display-name="Kundarak Warden" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#kundarak%20warden_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="kundarak%20warden_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Kundarak Warden</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
#### Lyrandar Scion
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Lyrandar Scion</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Lyrandar Scion|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="lyrandar%20scion_efa" data-rd-name="Lyrandar Scion" data-rd-display-name="Lyrandar Scion" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#lyrandar%20scion_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="lyrandar%20scion_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Lyrandar Scion</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
#### Medani Inquisitive
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Medani Inquisitive</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Medani Inquisitive|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="medani%20inquisitive_efa" data-rd-name="Medani Inquisitive" data-rd-display-name="Medani Inquisitive" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#medani%20inquisitive_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="medani%20inquisitive_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Medani Inquisitive</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
#### Orien Enforcer
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Orien Enforcer</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Orien Enforcer|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="orien%20enforcer_efa" data-rd-name="Orien Enforcer" data-rd-display-name="Orien Enforcer" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#orien%20enforcer_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="orien%20enforcer_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Orien Enforcer</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
#### Sentinel Marshal
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Sentinel Marshal</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Sentinel Marshal|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="sentinel%20marshal_efa" data-rd-name="Sentinel Marshal" data-rd-display-name="Sentinel Marshal" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#sentinel%20marshal_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="sentinel%20marshal_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Sentinel Marshal</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
#### Shadow-Marked Agent
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Shadow-Marked Agent</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Shadow-Marked Agent|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="shadow-marked%20agent_efa" data-rd-name="Shadow-Marked Agent" data-rd-display-name="Shadow-Marked Agent" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#shadow-marked%20agent_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="shadow-marked%20agent_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Shadow-Marked Agent</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
#### Sivis Scribe
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Sivis Scribe</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Sivis Scribe|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="sivis%20scribe_efa" data-rd-name="Sivis Scribe" data-rd-display-name="Sivis Scribe" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#sivis%20scribe_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="sivis%20scribe_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Sivis Scribe</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
#### Tharashk Hunter
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Tharashk Hunter</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Tharashk Hunter|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="tharashk%20hunter_efa" data-rd-name="Tharashk Hunter" data-rd-display-name="Tharashk Hunter" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#tharashk%20hunter_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="tharashk%20hunter_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Tharashk Hunter</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
#### Vadalis Heir
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Vadalis Heir</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Vadalis Heir|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="vadalis%20heir_efa" data-rd-name="Vadalis Heir" data-rd-display-name="Vadalis Heir" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#vadalis%20heir_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="vadalis%20heir_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Vadalis Heir</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
...
![An Armorer Explorer ventures into an ancient ruin in Xen'drik in search of magical secrets](img/book/EFA/060-06-001.an-armorer-explorer-exploring-ancient-ruins.webp)
...
***Emerald Claw Commander.*** Emerald Claw commanders lead large groups of soldiers, inspiring the fanatical devotion of Humanoids and Undead alike.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Emerald Claw Commander</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Emerald Claw Commander|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="emerald%20claw%20commander_efa" data-rd-name="Emerald Claw Commander" data-rd-display-name="Emerald Claw Commander" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#emerald%20claw%20commander_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="emerald%20claw%20commander_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Emerald Claw Commander</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>***Emerald Claw Knight.*** Knights of the Emerald Claw command squads of Humanoid or Undead soldiers. As they draw nearer to death, the chill of the grave suffuses their weapon attacks.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Emerald Claw Knight</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Emerald Claw Knight|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="emerald%20claw%20knight_efa" data-rd-name="Emerald Claw Knight" data-rd-display-name="Emerald Claw Knight" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#emerald%20claw%20knight_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="emerald%20claw%20knight_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Emerald Claw Knight</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
### Lords of Dust
...
![Morgrave University](img/book/EFA/062-06-003.morgrave-university.webp)
...
![](img/book/EFA/063-06-004.faces-of-morgrave.webp)
...
![Elemental airships aid archaeological expeditions to distant lands](img/book/EFA/064-06-005.elemental-airships.webp)
...
***Vulkoori Stingblade.*** Vulkoori drow warriors coat their weapons with the same deadly scorpion venom they use to tattoo their skin. Thanks to their extensive use of poison, they are resistant to the scorpion venom's full effects.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Vulkoori Stingblade</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Vulkoori Stingblade|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="vulkoori%20stingblade_efa" data-rd-name="Vulkoori Stingblade" data-rd-display-name="Vulkoori Stingblade" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#vulkoori%20stingblade_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="vulkoori%20stingblade_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Vulkoori Stingblade</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>***Vulkoori Venom Priest.*** Vulkoori venom priests delight in inflicting suffering through poison. Their weaponry and magic are carefully crafted to evoke the presence of the scorpion-god and strike terror into their enemies' hearts.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Vulkoori Venom Priest</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Vulkoori Venom Priest|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="vulkoori%20venom%20priest_efa" data-rd-name="Vulkoori Venom Priest" data-rd-display-name="Vulkoori Venom Priest" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#vulkoori%20venom%20priest_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="vulkoori%20venom%20priest_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Vulkoori Venom Priest</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>***Umbragen Shadow Walker.*** Umbragen drow are the descendants of drow who fled the giants and found refuge underground. For countless generations, they have lived in the lightless caverns of Khyber. There, they tapped into a mysterious magical shadow they called the Umbra. Though some have emerged to haunt the surface in the wake of the giant empire's fall, they retain a spiritual and physical connection to the darkness below. Umbragen shadow walkers weave shadow magic to confound foes.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Umbragen Shadow Walker</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="creature" data-rd-uid="Umbragen Shadow Walker|EFA" data-rd-page="bestiary.html" data-rd-source="EFA" data-rd-hash="umbragen%20shadow%20walker_efa" data-rd-name="Umbragen Shadow Walker" data-rd-display-name="Umbragen Shadow Walker" data-rd-style="narrow" data-rd-entry-data="{}">
				<i>Loading <a href="bestiary.html#umbragen%20shadow%20walker_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="bestiary.html" data-vet-source="EFA" data-vet-hash="umbragen%20shadow%20walker_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Umbragen Shadow Walker</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>![Vulkoori and Umbragen drow battle in a cavern filled with mysteries](img/book/EFA/065-06-006.drow-battle.webp)
...
***Bazek Mohl.*** Ancient giants built their so-called "City of Shadows" underground, in a manifest zone linked to the plane of *Mabar*, the realm of eternal night. The only indication on the surface of the city's presence far below is a toppled tower in the jungle, its shattered walls of purplish granite infused with shadow magic. Ancient texts in the archives of *House Phiarlan* suggest a connection between the ancestors of that house and Bazek Mohl, leading scholars to believe that the *Mark of Shadow* might relate to the shadow magic of this place.

***Mel-Aqat.*** For many years, people considered Mel-Aqat mere legend. Mentioned in a variety of ancient texts, this site was supposedly the prison for a mighty fiendish overlord. Until only a few years ago, most scholars had abandoned hope of finding it. Then it was unearthed by a group of adventurers led by the scholar Janik Martell. Fiendish power suffuses the ruins, but Celestial forces are at work there as well, and the *Church of the Silver Flame* is interested in supporting further expeditions there.

***Obsidian City.*** The Obsidian City is a ruined giant city now inhabited by a group of drow called the Sulatar ("firebinders"). It lies at least eight hundred miles upriver from Stormreach.

***Pra'xirek.*** Pra'xirek is a ruined giant city near one of the heads (sources) of the Hydra—the great sound that divides the Skyfall Peninsula from the rest of the continent. Two groups of giants still inhabit the ruins, as does a group of drow.

***Pyramid of Ebon Flame.*** The Pyramid of Ebon Flame is one of several scattered creations of the giant wizard-king Addis-Ro, a necromancer who experimented with powers drawn from the depths of Khyber. This huge monolith formed of unbreakable black glass supposedly marks the passage through which the wizard-king journeyed into the deeps.

***Ring of Storms.*** The Ring of Storms, according to legend, was the mountain refuge of a sect of powerful drow spellcasters during the Age of Giants. The fall of an enormous dragonshard from the Ring of Siberys destroyed this sect.

***Tharkgun Dhak.*** A cliffside fortress built by giants in the northern Fangs of Argarak, Tharkgun Dhak is a gateway to the depths of Khyber. Ogres control this site, now infested with Aberrations.

***Throne Gate Ruins.*** Aside from the ruins beneath Stormreach, the Throne Gate Ruins are the closest ruins to the city, about four hundred miles up the Rachi River. This site served as a temple and arcane laboratory at the height of the giant empire.
...
| 1d8 | Encounter                                                                                                                                    |
|:---:|----------------------------------------------------------------------------------------------------------------------------------------------|
| 1–3 | Four **Vulkoori Stingblades**                                                                                                                |
| 4–5 | One **Vulkoori Venom Priest** and two Vulkoori Stingblades                                                                                   |
...
***Crab Temple.*** The temple is a partially flooded ruin crafted by drow shortly after the fall of the empire of giants. Its name comes from a statue of a humanoid figure outside the ruins; someone removed the statue's head at one point, and a large crab's shell became lodged on its shoulders. Use the *Dragon's Lair map* in the *Dungeon Master's Guide* to represent the temple. (The statue on a dais in the northeast corner of the ruins gives the temple its name.) The temple rises slightly out of a lake, so everything below level 1 is submerged, including the stairs leading down to level 2.

***Ruin Denizens.*** A band of kuo-toa (one **Kuo-toa Monitor**, two **Kuo-toa Whips**, and five **Kuo-toa**) inhabits level 2 of the ruin. They swim quickly to level 1 and initiate combat if anything disturbs the water at the top of the stairs.

***Plundering the Ruins.*** By diving into the lower levels of the temple, the characters can find abundant ancient relics to make their expedition a success:
...
![Conflict between houses escalates to the skies as elemental airships join in battle](img/book/EFA/066-07-001.airship-battle.webp)
...
![](img/book/EFA/067-07-002.airship-getaway.webp)
...
***Mark of Shadow.*** If a creature with the Mark of Shadow occupies this crew station, that creature can take the Cloak action as a Bonus Action.
...
***Random Encounters.*** You may use the following table to generate random encounters as adventurers navigate the skies.
		...
		<thead>
			<tr>
				<th class="ve-rd__data-embed-header ve-text-left" colspan="6" data-rd-data-embed-header="true">
					<div class="ve-w-100 ve-split-v-center">
						<div class="ve-flex-v-center ve-w-100 ve-min-w-0">
							<span class="ve-rd__data-embed-name ve-hidden">Airborne Encounters</span>
							<span class="ve-rd__data-embed-name-expanded ve-text-right ve-pr-2 ve-w-100 "></span>
						</div>
						<span class="ve-rd__data-embed-toggle">[–]</span>
					</div>
			...
			<td colspan="6" data-rd-tag="table" data-rd-uid="Airborne Encounters|EFA" data-rd-page="tables.html" data-rd-source="EFA" data-rd-hash="airborne%20encounters_efa" data-rd-name="Airborne Encounters" data-rd-display-name="Airborne Encounters" data-rd-style="" data-rd-entry-data="{}">
				<i>Loading <a href="tables.html#airborne%20encounters_efa"  onmouseover="Renderer.hover.pHandleLinkMouseOver(event, this)" onmouseleave="Renderer.hover.handleLinkMouseLeave(event, this)" onmousemove="Renderer.hover.handleLinkMouseMove(event, this)" onclick="Renderer.hover.handleLinkClick(event, this)" onwheel="Renderer.hover.handleLinkWheel(event, this)" ondragstart="Renderer.hover.handleLinkDragStart(event, this)" data-vet-page="tables.html" data-vet-source="EFA" data-vet-hash="airborne%20encounters_efa" ontouchstart="Renderer.hover.handleTouchStart(event, this)" >Airborne Encounters</a>...</i>
				<style onload="Renderer.events.handleLoad_inlineStatblock(this)"></style>
			</td>
		</tr></tbody></table>
#### Navigation
...
|  3  | The airship passes through a lightning storm, which takes 1d4 hours. During this time, the area around the ship is Heavily Obscured, and any creature that starts its turn on the ship's deck must succeed on a DC 10 Dexterity saving throw or be struck by lightning and take 4 (1d8) Lightning damage.     |
...
![](img/book/EFA/071-08-001.magic-items-in-case.webp)
...
![](img/book/EFA/072-09-001.creating-a-warforged.webp)

![](img/book/EFA/073-09-002.forging.webp)

![](img/book/EFA/074-09-003.newly-forged.webp)

![](img/book/EFA/075-09-004.first-meeting.webp)

![](img/book/EFA/076-09-005.city-of-towers.webp)

![](img/book/EFA/077-09-006.on-the-trail.webp)

![](img/book/EFA/078-09-007.watching.webp)

![](img/book/EFA/079-09-008.battle-smith.webp)

![](img/book/EFA/080-09-009.kalashtar.webp)

![](img/book/EFA/081-09-010.investigate-murder.webp)

![](img/book/EFA/082-09-011.open-conflict.webp)

![](img/book/EFA/083-09-012.alchemist.webp)

![](img/book/EFA/084-09-013.a-meeting.webp)

![](img/book/EFA/085-09-015.airship.webp)

![](img/book/EFA/086-09-014.exploring-ruins.webp)

![](img/book/EFA/087-09-016.armorer.webp)

![](img/book/EFA/088-09-017.houses-in-conflict.webp)

![](img/book/EFA/089-09-018.artillerist.webp)

![](img/book/EFA/090-09-019.escape.webp)

![](img/book/EFA/091-09-020.mobile-bastion.webp)

![](img/book/EFA/092-09-021.returning.webp)
...
![On the Cover: An Artificer is hard at work creating a warforged in the forges of House Cannith in this piece by Michael Broussard.](img/book/EFA/093-09-001.traditional-cover-preview.webp)![On the Alt-Cover: Patrick Gañas shows us the completion of the process, as the Artificer brings the newly created warforged soldier out of the creation forge and into life.](img/book/EFA/094-09-002.alternate-cover-preview.webp)